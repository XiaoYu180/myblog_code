...
spring:
  datasource:
    mysql:
      ...
      jdbc-url: jdbc:mysql://172.16.12.217:3306/jcxnsjc?serverTimezone=UTC&userUnicode=true&characterEncoding=utf-8
      #设置驱动类
    ...
    oracle:
      ...
      jdbc-url: jdbc:oracle:thin:@172.16.12.217:1521:sjfxpt
      username: zbgl
      password: zbgl
      type: com.alibaba.druid.pool.DruidDataSource
